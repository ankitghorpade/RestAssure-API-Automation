...
public class InitiateAD {
    ...
    public InitiateAD() throws FileNotFoundException {
    }
    ...
    public void startADscan(String body, String statuscodes, String description, String expectedResult) {
        System.out.println("\n###############" + description + "###############\n");
...
//                .time(Matchers.lessThanOrEqualTo(15000L));
    ...
    public Object[][] initiateADscan() throws IOException {
