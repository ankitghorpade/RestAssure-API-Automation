...
public class InitiatePAScan {
    ...
    public InitiatePAScan() throws FileNotFoundException {
    };
    ...
    public void initiatePAScan(String body, String statuscodes, String description, String expectedResult) {
    ...
    public Object[][]  excelInitiatePAScan() throws IOException {
