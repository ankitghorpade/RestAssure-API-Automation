...
public class DeletePAScanConfig {
    ...
    public DeletePAScanConfig() throws FileNotFoundException {
    };
    ...
    public void deletePAScanConfig(String body, String statuscodes, String description, String expectedResult) {
    ...
    public Object[][]  excelDeletePAScanConfig() throws IOException {
