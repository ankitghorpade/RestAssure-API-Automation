...
public class UpdateDevice {
    ...
    public UpdateDevice() throws FileNotFoundException {
    }
    ...
    void updateDevice(String body, String statuscodes, String urlParam, String description, String expectedResult) {
        System.out.println("\n###############" + description + "###############\n");
        ...
        if (String.valueOf(response.statusCode()).equals(config.statusCode200())) {
            ...
            if ((data.getStatusMessage().equals(config.statusSuccess().toUpperCase()))) {
                ...
                deleteDevice.deleteDevice(config.delDEVICE().replace("INJECT_HOSTNAME", data.getResponseHostName()),
                        config.statusCode200(), data.getRequestAccName(), "DELETE DEVICE",
    ...
    public Object[][]  excelUpdateDevice() throws IOException {
